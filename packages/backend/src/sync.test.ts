...
// No bank tests here: the backend does not poll MoneyMoney at all any more. The
// Mac agent collects it (@dash/agent — single-flight + failure handling covered
// by bank-agent.test.ts) and pushes it to `pushBankBacklog`, whose recording is
// covered by bank.test.ts.
